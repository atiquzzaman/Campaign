...
describe('Date related tests', function() {
  ...
  it('check start date after end date', function() {
  ...
  it('check start date and end date are equal', function() {
    const startDate = utils.getInputDate('3/15/2018')
  ...
  it('check current date, start date and end date are equal', function() {
  ...
  it('check current date between start date and end date', function() {
